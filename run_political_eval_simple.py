#!/usr/bin/env python3
"""
Script to run retroactive evaluation on the political experiment trajectories.
...
# Configuration
RUN_NAME = "political-01-11_06-13-22"
...
# Metrics to evaluate for political environment
METRICS = [
    "political_agreement",
...
def main():
    ...
    # Check if iteration 9 exists
    iteration_path = RUN_PATH / "9"
    if not iteration_path.exists():
        print(f"ERROR: Iteration 9 does not exist: {iteration_path}")
        sys.exit(1)
